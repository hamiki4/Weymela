...
Every endpoint enforces role and resource ownership server-side. Account Terms/Privacy acceptance stores the exact current document version and immutable consent evidence once per Weymela UserId. Business, Creator, and anti-circumvention agreements remain independently role-scoped.
