...
public sealed partial class ApiSafetyMiddleware(RequestDelegate next, RuntimeOptions options,
    ProductIntegrationOptions productIntegration, ILogger<ApiSafetyMiddleware> logger)
{
