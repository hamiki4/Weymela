...
internal static class DeviceSessionRequestPolicy
{
    ...
    private static readonly HashSet<string> MeaningfulPosts = new(StringComparer.Ordinal)
    {
        ...
        "/api/business/promotion-content-submissions/{id:guid}/review",
        "/api/business/cashiers",
        "/api/business/cashiers/{id:guid}/activation-code",
        "/api/business/cashiers/{id:guid}/{state}",
        "/api/business/deposit-requests",
        "/api/creator/campaigns/{id:guid}/join",
        "/api/creator/promotions/{id:guid}/request",
        "/api/creator/creator-budgets/{id:guid}/content",
        "/api/creator/creator-budgets/{id:guid}/go-live",
        ...
        "/api/checkout/manual-resolve",
        "/api/checkout/manual-confirm",
