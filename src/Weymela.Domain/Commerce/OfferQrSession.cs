...
public sealed class OfferQrSession
{
    ...
    public OfferQrSession(Guid customer, Guid promotion, Guid creator, Guid allocation, Guid business, string tokenHash, DateTime issuedAt, string key)
    {
        ...
        CustomerId = customer; PromotionId = promotion; CreatorId = creator; CreatorAllocationId = allocation; BusinessId = business;
    ...
    {
        Validate(business, at); SaleId = saleId; UsedAtUtc = at; Status = OfferQrStatus.Used; Version++;
    }
